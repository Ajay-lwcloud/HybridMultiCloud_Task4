...
resource "aws_instance" "mysql"{
  ...
  user_data = <<-EOF
	...
	sudo docker run -dit -e MYSQL_ROOT_PASSWORD=ash -e MYSQL_DATABASE=data -e MYSQL_USER=ajay  -e MYSQL_PASSWORD=ajay1 -p 8080:3306 --name dbos mysql:5.7
  EOF
...
resource "aws_instance" "wordpress"{
 ...
 ami = "ami-08706cb5f68222d09"
  ...
  connection {
    type     = "ssh"
    user     = "ec2-user"
    private_key = file("C:/Users/nidhi/Downloads/Ajay_Key_2.pem")
